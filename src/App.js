...
const Home = () => {
  ...
  useEffect(() => {
    //posto smo klikom na stranicu promenili api,kako cemo sad iskoristiti podatke iz toga za nas server?pomocu useEffect
    (async function () {
      //koristumo async funkcije za feching data
